module github.com/algo2go/kite-mcp-usecases
...
require (
	github.com/algo2go/kite-mcp-alerts v0.6.1
	github.com/algo2go/kite-mcp-broker v0.1.1
	github.com/algo2go/kite-mcp-cqrs v0.1.1
	github.com/algo2go/kite-mcp-domain v0.1.1
	...
	github.com/algo2go/kite-mcp-riskguard v0.2.1
	github.com/algo2go/kite-mcp-users v0.2.1
	github.com/google/uuid v1.6.0 // indirect
	github.com/stretchr/testify v1.11.1
)

require (
	github.com/algo2go/kite-mcp-audit v0.2.1
	github.com/algo2go/kite-mcp-ticker v0.1.0
	github.com/algo2go/kite-mcp-watchlist v0.2.1
)
