...
func TestFamilyUseCases_BusIntegration_EndToEnd(t *testing.T) {
	...
	bus.Register(reflect.TypeOf(cqrs.AdminListFamilyQuery{}), func(ctx context.Context, msg any) (any, error) {
		return listUC.Execute(ctx, msg.(cqrs.AdminListFamilyQuery))
	})
	bus.Register(reflect.TypeOf(cqrs.AdminInviteFamilyMemberCommand{}), func(ctx context.Context, msg any) (any, error) {
		return inviteUC.Execute(ctx, msg.(cqrs.AdminInviteFamilyMemberCommand))
	})
	bus.Register(reflect.TypeOf(cqrs.AdminRemoveFamilyMemberCommand{}), func(ctx context.Context, msg any) (any, error) {
